...
import xenon.proto.xenon_pb2 as xenon_dot_proto_dot_xenon__pb2
...
class XenonGlobalStub(object):
  ...
  def __init__(self, channel):
    ...
    self.newXenon = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Properties.SerializeToString,
    ...
    self.getSupportedProperties = channel.unary_unary(
        ...
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.PropertyDescriptions.FromString,
        )
...
def add_XenonGlobalServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'newXenon': grpc.unary_unary_rpc_method_handler(
          servicer.newXenon,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Properties.FromString,
      ...
      'getSupportedProperties': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=xenon_dot_proto_dot_xenon__pb2.PropertyDescriptions.SerializeToString,
      ),
  }
...
class XenonFilesStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getAdaptorDescriptions = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.FileAdaptorDescriptions.FromString,
        )
    self.getAdaptorDescription = channel.unary_unary(
        ...
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.FileAdaptorDescription.FromString,
        )
    self.newFileSystem = channel.unary_unary(
        '/xenon.XenonFiles/newFileSystem',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.NewFileSystemRequest.SerializeToString,
    ...
    self.backgroundCopy = channel.unary_unary(
        ...
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.Copy.FromString,
        )
    self.cancelBackgroundCopy = channel.unary_unary(
        '/xenon.XenonFiles/cancelBackgroundCopy',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Copy.SerializeToString,
    ...
    self.listBackgroundCopyStatuses = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.CopyStatuses.FromString,
        )
    ...
    self.move = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.SourceTarget.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
        )
    ...
    self.read = channel.unary_stream(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Path.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.FileStream.FromString,
        )
    self.write = channel.stream_unary(
        '/xenon.XenonFiles/write',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.WriteRequest.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
        )
    self.walkFileTree = channel.unary_stream(
        '/xenon.XenonFiles/walkFileTree',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.WalkFileTreeRequest.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.PathWithAttributes.FromString,
        )
    self.getAttributes = channel.unary_unary(
        '/xenon.XenonFiles/getAttributes',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Path.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.FileAttributes.FromString,
        )
    self.setPosixFilePermissions = channel.unary_unary(
        '/xenon.XenonFiles/setPosixFilePermissions',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.PosixFilePermissionsRequest.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
        )
...
def add_XenonFilesServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'getAdaptorDescriptions': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.FileAdaptorDescriptions.SerializeToString,
      ),
      'getAdaptorDescription': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=xenon_dot_proto_dot_xenon__pb2.FileAdaptorDescription.SerializeToString,
      ),
      'newFileSystem': grpc.unary_unary_rpc_method_handler(
          servicer.newFileSystem,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.NewFileSystemRequest.FromString,
      ...
      'backgroundCopy': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=xenon_dot_proto_dot_xenon__pb2.Copy.SerializeToString,
      ),
      'cancelBackgroundCopy': grpc.unary_unary_rpc_method_handler(
          servicer.cancelBackgroundCopy,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Copy.FromString,
      ...
      'listBackgroundCopyStatuses': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.CopyStatuses.SerializeToString,
      ),
      ...
      'move': grpc.unary_unary_rpc_method_handler(
          servicer.move,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.SourceTarget.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
      ),
      ...
      'read': grpc.unary_stream_rpc_method_handler(
          servicer.read,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Path.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.FileStream.SerializeToString,
      ),
      'write': grpc.stream_unary_rpc_method_handler(
          servicer.write,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.WriteRequest.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
      ),
      'walkFileTree': grpc.unary_stream_rpc_method_handler(
          servicer.walkFileTree,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.WalkFileTreeRequest.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.PathWithAttributes.SerializeToString,
      ),
      'getAttributes': grpc.unary_unary_rpc_method_handler(
          servicer.getAttributes,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Path.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.FileAttributes.SerializeToString,
      ),
      'setPosixFilePermissions': grpc.unary_unary_rpc_method_handler(
          servicer.setPosixFilePermissions,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.PosixFilePermissionsRequest.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
      ),
...
class XenonJobsStub(object):
  ...
  def __init__(self, channel):
    ...
    self.getAdaptorDescriptions = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.Empty.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.JobAdaptorDescriptions.FromString,
        )
    self.getAdaptorDescription = channel.unary_unary(
        '/xenon.XenonJobs/getAdaptorDescription',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.AdaptorName.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.JobAdaptorDescription.FromString,
        )
    self.newScheduler = channel.unary_unary(
        '/xenon.XenonJobs/newScheduler',
        request_serializer=xenon_dot_proto_dot_xenon__pb2.NewSchedulerRequest.SerializeToString,
    ...
    self.submitJob = channel.unary_unary(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.SubmitJobRequest.SerializeToString,
    ...
    self.getStreams = channel.stream_stream(
        ...
        request_serializer=xenon_dot_proto_dot_xenon__pb2.JobInputStream.SerializeToString,
        response_deserializer=xenon_dot_proto_dot_xenon__pb2.JobOutputStreams.FromString,
        )
    self.isOpen = channel.unary_unary(
...
def add_XenonJobsServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'getAdaptorDescriptions': grpc.unary_unary_rpc_method_handler(
          servicer.getAdaptorDescriptions,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Empty.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.JobAdaptorDescriptions.SerializeToString,
      ),
      'getAdaptorDescription': grpc.unary_unary_rpc_method_handler(
          servicer.getAdaptorDescription,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.AdaptorName.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.JobAdaptorDescription.SerializeToString,
      ),
      'newScheduler': grpc.unary_unary_rpc_method_handler(
          servicer.newScheduler,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.NewSchedulerRequest.FromString,
      ...
      'submitJob': grpc.unary_unary_rpc_method_handler(
          servicer.submitJob,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.SubmitJobRequest.FromString,
      ...
      'getStreams': grpc.stream_stream_rpc_method_handler(
          servicer.getStreams,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.JobInputStream.FromString,
          response_serializer=xenon_dot_proto_dot_xenon__pb2.JobOutputStreams.SerializeToString,
      ),
      'isOpen': grpc.unary_unary_rpc_method_handler(
          servicer.isOpen,
          request_deserializer=xenon_dot_proto_dot_xenon__pb2.Scheduler.FromString,
